#############################################################################
# Makefile for building: Applecoin-qt
# Generated by qmake (2.01a) (Qt 4.8.4) on: Sun 1. Dec 22:02:03 2013
# Project:  applecoin-qt.pro
# Template: app
# Command: c:\Qt\4.8.4\bin\qmake.exe USE_UPNP=1 -o Makefile applecoin-qt.pro
#############################################################################
...
Makefile: applecoin-qt.pro  c:/Qt/4.8.4/mkspecs/win32-g++/qmake.conf c:/Qt/4.8.4/mkspecs/features/device_config.prf \
	...
	$(QMAKE) USE_UPNP=1 -o Makefile applecoin-qt.pro
