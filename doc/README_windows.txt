...
After completing windows setup then run windows command line (cmd)
  cd daemon
  Applecoind
You would need to create a configuration file Applecoin.conf in the default
wallet directory. Grant access to Applecoind.exe in anti-virus and firewall
...
Applecoind backupwallet <destination_backup_file>
Then shutdown ppcoind by
Applecoind stop
Start up the new Applecoind (0.3.0).
